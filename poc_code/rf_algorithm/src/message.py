...
class Message:
    ...
    def __init__(self, header: Header, payload: MsgObject | None) -> None:
        ...
        Args:
            header (Header): Contains information about the message.
            payload (MsgObject | None): Actual data of the message.
        """
        self.header = header
    ...
    def check_crc_and_signature(msg: SignedMessage) -> bytes | None:
        ...
        Args:
            msg (SignedMessage): Message to be validated.

        Returns:
            bytes | None: Original message data or None if the checksums don't match.
        """       
    ...
    def get_curr_loc_msg(d_id: str, x: float, y: float, z: float) -> SignedMessage:
        ...
        Args:
            d_id (str): drone id
            x (float): drone x coordinate
            y (float): drone y coordinate
            z (float): drone x coordinate
    ...
    def get_enable_jammer(d_id: str, duration: float) -> SignedMessage:
        ...
        Args:
            d_id (str): drone id
            duration (float): number of seconds jammer is enabled for
    ...
    def get_disable_jammer(d_id: str, disable_delay: float) -> SignedMessage:
        ...
        Args:
            d_id (str): drone id
            duration (float): number of seconds jammer is disabled for
    ...
    def get_enable_rf_deception(d_id: str, duration: float) -> SignedMessage:
        ...
        Args:
            d_id (str): drone id
            duration (float): number of seconds RF deception is enabled for
    ...
    def get_disable_rf_deception(d_id: str, delay: float) -> SignedMessage:
        ...
        Args:
            d_id (str): drone id
            duration (float): number of seconds RF deception is delayed for
    ...
    def curr_loc(msg: SignedMessage) -> "Message":
        ...
        Args:
            msg (SignedMessage): Message to deserialize.
    ...
    def serialize_msg(msg_type: str, msg_type_args: list[any]) -> SignedMessage | None:
        ...
        Args:
            msg_type (str): Type of message to be serialized.
            msg_type_args (list[any]): Passed to the message creation function based on given message type.
